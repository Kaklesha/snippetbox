...
func (m *UserModel) Insert(name, email, password string) error {
	...
	if err != nil {
		...
		// checking if the error code equals 1062 and the contents of the eггог
...
func (m *UserModel) Authenticate(email, password string) (int, error) {
	...
	//Check whether the password and plain-text password provided match.
